...
contract TRC20 is ITRC20, Ownable {
    ...
    /**
     * @dev Total number of tokens were burnt
     */
...
contract GAME_TRC20 is TRC20Burnable, TRC20Detailed, TRC20Mintable {

      constructor(address mintSaver, address burnableStorage) public TRC20Detailed("TronGAME", "GAME", 6) TRC20Burnable(burnableStorage) {
        mint(mintSaver, 100000000000000);
    }
